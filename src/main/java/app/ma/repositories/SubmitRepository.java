...
public interface SubmitRepository extends PagingAndSortingRepository<Submit, Long> {
	...
	public Submit findFirst1ByProblemContestUser_User_IdAndProblemContestUser_ProblemContest_Contest_IdAndProblemContestUser_ProblemContest_Problem_IdOrderBySubmitDateDesc(Long userId, Long contestId, Long problemId);
